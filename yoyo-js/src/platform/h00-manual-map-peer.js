...
const H00_RELOAD_R15_SITES = [
  7, 21, 125, 185, 248, 289, 303, 707, 1004, 2099, 2122, 2145, 2168, 2191, 2214, 2237, 2260,
];
const H00_IAT_SITES = [
  [79, 1], // CreateFileA
  [158, 0], // VirtualAlloc (file buffer)
  [225, 2], // ReadFile
  [270, 4], // CloseHandle
  [345, 0], // VirtualAlloc (image)
  [2093, 5], // ExitProcess (export success)
];
