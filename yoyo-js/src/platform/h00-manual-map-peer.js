...
const H00_IAT_SITES = [
  ...
  [1818, 5], // ExitProcess (export success)
  [1837, 5], // ExitProcess (fail CreateFile)
  [1856, 5], // ExitProcess (fail Read)
  [1875, 5], // ExitProcess (fail VirtualAlloc)
  [1894, 5], // ExitProcess (fail section_copy)
  [1913, 5], // ExitProcess (fail reloc)
  [1932, 5], // ExitProcess (fail import)
  [1951, 5], // ExitProcess (fail export)
  [1970, 5], // ExitProcess (fail DllMain — epilogue only, DllMain skipped)
];
