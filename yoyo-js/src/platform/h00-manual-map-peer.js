...
const H00_IAT_SITES = [
  ...
  [1804, 5], // ExitProcess (export success)
  [1815, 5], // ExitProcess (fail CreateFile)
  [1826, 5], // ExitProcess (fail Read)
  [1837, 5], // ExitProcess (fail VirtualAlloc)
  [1848, 5], // ExitProcess (fail section_copy)
  [1859, 5], // ExitProcess (fail reloc)
  [1870, 5], // ExitProcess (fail import)
  [1881, 5], // ExitProcess (fail export)
  [1892, 5], // ExitProcess (fail DllMain — epilogue only, DllMain skipped)
];
