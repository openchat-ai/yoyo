...
function checkMEMCPYDATA_STUB() {
  ...
  // MEMCPY_DATA stub: encodeOp returns C3 bytes; fixture compile mirrors stub.
  const expected = loadExpectedHex(expPath);
  ...
  return { id: 'MEMCPY-DATA-50-51-40', ok: true, detail: `code=${hexOf(got)} (stub=C3; semantic gap)` };
}

function checkMEMCPYSTATE_STUB() {
  ...
  return { id: 'MEMCPY-STATE-50-51-40', ok: true, detail: `code=${hexOf(got)} (stub=C3; semantic gap)` };
}
