...
```text
[x] A  [x] B  [x] C   →  Stage 5–9 已毕业 → **下一主线：Stage 10 / v0.4**（见文末指针）
```
...
## v0.1–v0.3 已发布 → v0.4 下一主线

> Stage 4–9 勾选 **保持不变**，勿回改。Stage 9 / v0.3 已毕业；下一主线为 Stage 10 / v0.4：

| 文档 | 用途 |
| ---- | ---- |
| [`SCOPE-v0.4.md`](./SCOPE-v0.4.md) | v0.4 一页纸：宿主信任面再收、IN/OUT、毕业门禁 |
| [`STAGE10_OWNER_CHECKLIST.md`](./STAGE10_OWNER_CHECKLIST.md) | Stage 10 actionable 看板（A→D）；发 `继续` 从 **A（runtime.dll 面）** 起 |
| [`SCOPE-v0.3.md`](./SCOPE-v0.3.md) / [`STAGE9_OWNER_CHECKLIST.md`](./STAGE9_OWNER_CHECKLIST.md) | v0.3 历史边界与已毕业看板（勿回改勾选） |
| [`SCOPE-v0.2.md`](./SCOPE-v0.2.md) / [`STAGE8_OWNER_CHECKLIST.md`](./STAGE8_OWNER_CHECKLIST.md) | v0.2 历史边界与已毕业看板（勿回改勾选） |
| [`RELEASE-v0.3.md`](./RELEASE-v0.3.md) | v0.3 发布边界（诚实剩余面 → v0.4 IN） |

**v0.1 / v0.2 发布边界**：[`RELEASE-v0.1.md`](./RELEASE-v0.1.md) · [`RELEASE-v0.2.md`](./RELEASE-v0.2.md)