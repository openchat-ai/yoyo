/**
 * parallel-batch-47 probe — scratch-only fresh picks after H_342..H_349.
 * Mirror parallel-batch-46-run.mjs. Do NOT touch yoyo.ty / lock / goldens.
 */
...
// Fresh vs H_48..H_349. Skip D-1/D-2/D-3 / MEMCPY. No AND/XOR.
// Slot disp: 50→0x280, 51→0x288, 52→0x290, 60→0x300.
// Store disp LE: 50→80, 51→88, 52→90.
// LDB oo=E8 triad after E0; ADD/SUB imm=E0 fresh after D8.
const picks = [
  {
    name: 'ldb_5060_e8',
    opcode: '0x80 LDB',
    args: 'dd=0x50 ss=0x60 oo=0xE8',
    body: '80 50 60 E8',
    expected: pinOf(0x80, [0x50, 0x60, 0xe8]),
  },
  {
    name: 'ldb_5160_e8',
    opcode: '0x80 LDB',
    args: 'dd=0x51 ss=0x60 oo=0xE8',
    body: '80 51 60 E8',
    expected: pinOf(0x80, [0x51, 0x60, 0xe8]),
  },
  {
    name: 'ldb_5260_e8',
    opcode: '0x80 LDB',
    args: 'dd=0x52 ss=0x60 oo=0xE8',
    body: '80 52 60 E8',
    expected: pinOf(0x80, [0x52, 0x60, 0xe8]),
  },
  {
    name: 'addimm_h50_e0',
    opcode: '0x62 ADD-IMM',
    args: 'slot=0x50 imm=0xE0',
    body: '62 50 E0',
    expected: pinOf(0x62, [0x50, 0xe0]),
  },
  {
    name: 'addimm_h51_e0',
    opcode: '0x62 ADD-IMM',
    args: 'slot=0x51 imm=0xE0',
    body: '62 51 E0',
    expected: pinOf(0x62, [0x51, 0xe0]),
  },
  {
    name: 'addimm_h52_e0',
    opcode: '0x62 ADD-IMM',
    args: 'slot=0x52 imm=0xE0',
    body: '62 52 E0',
    expected: pinOf(0x62, [0x52, 0xe0]),
  },
  {
    name: 'subimm_h50_e0',
    opcode: '0x61 SUB-IMM',
...
const logPath = path.join(ROOT, 'docs/auxdocs/parallel-batch-47-log.md');
const table = rows
  .map(
    (r, i) =>
...
const H0 = 350;
const SEL0 = 0x164;
const PIN = 'edee584aa21a26569fe08e60d5089daf8d823c9df4c829c62b788b10815f4a51';
...
const log = `# parallel-batch-47 Log · 8-pick fresh-picks scratch test sweep
...
Pass pin from body-extend-052 Relock: \`${PIN}\`.
...
const summaryPath = path.join(ROOT, 'scripts/_probe/parallel-batch-47-summary.json');
fs.writeFileSync(
  summaryPath,
  JSON.stringify(
    {
