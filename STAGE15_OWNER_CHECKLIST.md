...
**Post-v1.0（2026-08-29）：** OW-H00 — JS/asm H_00 entry **JMP+NOP 18B** 与 Rust 对齐；three-peer full `.text` **EQUAL**（sha `808b9ec8`）· **CLOSED**。OW-STUB shrink-2：**96→69** B（AddressOfFunctions[0]）；**仍 CUT**。
