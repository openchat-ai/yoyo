# parallel-batch-17 SPAWN · scratch-only (post body-extend-022)

> Continuous queue handoff from body-extend-022.
> Pin after Relock: `c2d5106637e7fd4954668c06dba34a2d699f1b36a6053a8df027c19b251504eb` (abbrev `c2d51066…`).
> Handlers = 116 (H_00..H_109). Last selectors: 0x6C..0x73 = H_102..H_109.
> Source protocol: mirror `docs/auxdocs/parallel-batch-16-log.md` / batch-15 shape.
> No Task tool available on consolidator — this SPAWN is the handoff artifact.

## Task: parallel-batch-17 (scratch-only)

1. Write `docs/auxdocs/parallel-batch-17-log.md`.
2. Pick 6–8 NEW scratch variants NOT already handlers in `yoyo/projects/yoyo.ty` (after H_102..H_109).
3. Skip D-1 0x20/0x50/0x51, D-2 0x64, D-3 0x84/0x85 (MEMCPY).
4. Prefer fresh slot/imm/alt-slot of INC/DEC/ADD-IMM/SUB-IMM/GET/SET/ADDV/ORV/SUBV/IMUL/CMP/LDB not duplicating H_48–H_109.
5. Scratch-only: do NOT touch yoyo.ty / lock / golden.js / self_test / main.
6. Each pick: write `_scratch_*.ty` + `_scratch_*.code.hex`; verify JS↔Rust byte-eq; record PASS/REJECT in log.
7. After scratches done: append "parent next = body-extend-023 serialize PASSes + 1 Relock" and **immediately spawn** body-extend-023 consolidation Task (same chain protocol), passing pin `c2d5106637e7fd49…` and the PASS list. If no Task tool: write `docs/auxdocs/body-extend-023-SPAWN.md`.
...
- SET slot/imm not in locked SET set (e.g. slot 52 fresh imm ≠ CAFEBABE/FEEDFACE/11111111; slot 51/50 fresh imm ≠ DEADBEEF/AABBCCDD/C0FFEE00/12345678/F00DBABE/BEEFCAFE)
- GET 50 51 · ORV 50 51 · SUBV 50 51 · ADDV 50 51 (pairs not in locked set)
- LDB dd/ss/oo variants (e.g. oo=20/28/30; dd=50 oo=10) ≠ H_61/H_69/H_90/H_98/H_99/H_103/H_104
