# parallel-batch-29 SPAWN · scratch-only (post body-extend-034)

> Continuous queue handoff from body-extend-034.
> Pin after Relock: `e531a0a8962e21ecce4f085df042195b60eb72b69f90d468f04cfeaa9c283588` (abbrev `e531a0a8…`).
> Handlers = 212 (H_00..H_205). Last selectors: 0xCC..0xD3 = H_198..H_205.
> Source protocol: mirror `docs/auxdocs/parallel-batch-28-log.md` / batch-27 shape.
> No Task tool available on consolidator — this SPAWN is the handoff artifact.
> NOTE: body-extend-034 DDC PE `.text` measured EQUAL this beat — still EXPERIMENTAL · NON-GREEN; do not invent-green.

## Task: parallel-batch-29 (scratch-only)

1. Write `docs/auxdocs/parallel-batch-29-log.md`.
2. Pick 6–8 NEW scratch variants NOT already handlers in `yoyo/projects/yoyo.ty` (after H_198..H_205).
...
- ADD-IMM / SUB-IMM fresh imm=60
- LDB oo=80 next rung (dd=50/51/52)
