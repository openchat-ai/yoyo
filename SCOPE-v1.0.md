...
> **前提**：已发布 v0.1–**v0.4.0**；**现主线** Stage 11 / v0.5。  
...
| **v0.5** | 11 | YOYO-built/更薄 runtime · 收缩 LoadLibrary host · 回归 · 毕业 | `SCOPE-v0.5` · `STAGE11` |
| **v0.6** | 12 | 三 peer I/O · section-ddc on selfhost body · 回归 · 毕业 | `SCOPE-v0.6` · `STAGE12` |
...
> **v0.5 现状**：Stage 11 从 A（YOYO-built / 更薄 runtime）起；v0.4 已毕业勿回改。
